...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_RRc_con_comp_g0");
    reader.add_event(23, 23, "include", "/covariates/case_data.stan");
    reader.add_event(23, 0, "start", "/covariates/case_data.stan");
    reader.add_event(26, 3, "end", "/covariates/case_data.stan");
    reader.add_event(26, 24, "restart", "model_RRc_con_comp_g0");
    reader.add_event(40, 38, "include", "/vanilla/tdata_allKd.stan");
    reader.add_event(40, 0, "start", "/vanilla/tdata_allKd.stan");
    reader.add_event(43, 3, "end", "/vanilla/tdata_allKd.stan");
    reader.add_event(43, 39, "restart", "model_RRc_con_comp_g0");
    reader.add_event(43, 39, "include", "/covariates/case_tdata_declare.stan");
    reader.add_event(43, 0, "start", "/covariates/case_tdata_declare.stan");
    reader.add_event(47, 4, "end", "/covariates/case_tdata_declare.stan");
    reader.add_event(47, 40, "restart", "model_RRc_con_comp_g0");
    reader.add_event(47, 40, "include", "/covariates/case_tdata_calc.stan");
    reader.add_event(47, 0, "start", "/covariates/case_tdata_calc.stan");
    reader.add_event(53, 6, "end", "/covariates/case_tdata_calc.stan");
    reader.add_event(53, 41, "restart", "model_RRc_con_comp_g0");
    reader.add_event(127, 115, "include", "/covariates/case_tpar_scale.stan");
    reader.add_event(127, 0, "start", "/covariates/case_tpar_scale.stan");
    reader.add_event(134, 7, "end", "/covariates/case_tpar_scale.stan");
    reader.add_event(134, 116, "restart", "model_RRc_con_comp_g0");
    reader.add_event(156, 138, "include", "/vanilla/tpar_augYd.stan");
    reader.add_event(156, 0, "start", "/vanilla/tpar_augYd.stan");
    reader.add_event(157, 1, "end", "/vanilla/tpar_augYd.stan");
    reader.add_event(157, 139, "restart", "model_RRc_con_comp_g0");
    reader.add_event(157, 139, "include", "/covariates/case_tpar_aug_comp.stan");
    reader.add_event(157, 0, "start", "/covariates/case_tpar_aug_comp.stan");
    reader.add_event(166, 9, "end", "/covariates/case_tpar_aug_comp.stan");
    reader.add_event(166, 140, "restart", "model_RRc_con_comp_g0");
    reader.add_event(180, 154, "include", "/covariates/case_model.stan");
    reader.add_event(180, 0, "start", "/covariates/case_model.stan");
    reader.add_event(184, 4, "end", "/covariates/case_model.stan");
    reader.add_event(184, 155, "restart", "model_RRc_con_comp_g0");
    reader.add_event(205, 176, "include", "/OneGroup/OneGroup_Rsq.stan");
    reader.add_event(205, 0, "start", "/OneGroup/OneGroup_Rsq.stan");
    reader.add_event(225, 20, "end", "/OneGroup/OneGroup_Rsq.stan");
    reader.add_event(225, 177, "restart", "model_RRc_con_comp_g0");
    reader.add_event(233, 185, "include", "/include/license.stan");
    reader.add_event(233, 0, "start", "/include/license.stan");
    reader.add_event(247, 14, "end", "/include/license.stan");
    reader.add_event(247, 186, "restart", "model_RRc_con_comp_g0");
    reader.add_event(249, 186, "end", "model_RRc_con_comp_g0");
    return reader;
}
#include <stan_meta_header.hpp>
class model_RRc_con_comp_g0
  : public stan::model::model_base_crtp<model_RRc_con_comp_g0> {
private:
        int Nd;
        int Np;
        int Kd2;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "Yp", "matrix_d", context__.to_vec(Np,Kp));
            Yp = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(Np, Kp);
            vals_r__ = context__.vals_r("Yp");
            pos__ = 0;
            size_t Yp_j_2_max__ = Kp;
            size_t Yp_j_1_max__ = Np;
            for (size_t j_2__ = 0; j_2__ < Yp_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < Yp_j_1_max__; ++j_1__) {
                    Yp(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
            current_statement_begin__ = 26;
            validate_non_negative_index("IDpp", "Np", Np);
            context__.validate_dims("data initialization", "IDpp", "int", context__.to_vec(Np));
            IDpp = std::vector<int>(Np, int(0));
            vals_i__ = context__.vals_i("IDpp");
            pos__ = 0;
            size_t IDpp_k_0_max__ = Np;
            for (size_t k_0__ = 0; k_0__ < IDpp_k_0_max__; ++k_0__) {
                IDpp[k_0__] = vals_i__[pos__++];
            }
            ...
            stan::math::assign(allKp,((2 * Kd2) + Kp));
            current_statement_begin__ = 46;
            validate_non_negative_index("limKp", "Kp", Kp);
            validate_non_negative_index("limKp", "2", 2);
            limKp = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(Kp, 2);
            stan::math::fill(limKp, DUMMY_VAR__);
            current_statement_begin__ = 47;
            validate_non_negative_index("halfRangeKp", "Kp", Kp);
            halfRangeKp = Eigen::Matrix<double, Eigen::Dynamic, 1>(Kp);
            stan::math::fill(halfRangeKp, DUMMY_VAR__);
            // execute transformed data statements
            current_statement_begin__ = 49;
            for (int k = 1; k <= Kp; ++k) {
                current_statement_begin__ = 50;
                stan::model::assign(limKp, 
                            stan::model::cons_list(stan::model::index_uni(k), stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list())), 
                            min(stan::model::rvalue(Yp, stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list())), "Yp")), 
                ...
                stan::model::assign(limKp, 
                            ...
                            max(stan::model::rvalue(Yp, stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list())), "Yp")), 
                            "assigning variable limKp");
                current_statement_begin__ = 52;
                stan::model::assign(halfRangeKp, 
                            stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list()), 
                            ((get_base1(limKp, k, 2, "limKp", 1) - get_base1(limKp, k, 1, "limKp", 1)) / 2), 
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> sub_S_p(allKp);
            stan::math::initialize(sub_S_p, DUMMY_VAR__);
            stan::math::fill(sub_S_p, DUMMY_VAR__);
            stan::math::assign(sub_S_p,rep_vector(1, allKp));
            current_statement_begin__ = 131;
            for (int k = ((2 * Kd2) + 1); k <= allKp; ++k) {
                current_statement_begin__ = 131;
                stan::model::assign(sub_S_p, 
                            stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list()), 
                            get_base1(S_p, k, "S_p", 1), 
                            "assigning variable sub_S_p");
            }
            current_statement_begin__ = 132;
            stan::math::assign(chol_p, diag_pre_multiply(sub_S_p, chol_r_p));
            }
            {
            ...
            for (int n = 1; n <= Np; ++n) {
                ...
                stan::model::assign(augYp, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::cons_list(stan::model::index_min_max(1, (2 * Kd2)), stan::model::nil_index_list())), 
                            stan::model::rvalue(AP, stan::model::cons_list(stan::model::index_uni(n), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "AP"), 
                            "assigning variable augYp");
                current_statement_begin__ = 162;
                for (int k = 1; k <= Kp; ++k) {
                    current_statement_begin__ = 164;
                    stan::model::assign(augYp, 
                                stan::model::cons_list(stan::model::index_uni(n), stan::model::cons_list(stan::model::index_uni(((2 * Kd2) + k)), stan::model::nil_index_list())), 
                                get_base1(Yp, get_base1(IDpp, n, "IDpp", 1), k, "Yp", 1), 
                                "assigning variable augYp");
                }
            }
            ...
            for (int k = 1; k <= Kp; ++k) {
                ...
                lp_accum__.add(normal_log<propto__>(get_base1(S_p, ((2 * Kd2) + k), "S_p", 1), (get_base1(halfRangeKp, k, "halfRangeKp", 1) / 5), (get_base1(halfRangeKp, k, "halfRangeKp", 1) / 5)));
                if (get_base1(S_p, ((2 * Kd2) + k), "S_p", 1) < 0) lp_accum__.add(-std::numeric_limits<double>::infinity());
                else lp_accum__.add(-normal_ccdf_log(0, (get_base1(halfRangeKp, k, "halfRangeKp", 1) / 5), (get_base1(halfRangeKp, k, "halfRangeKp", 1) / 5)));
            }
            current_statement_begin__ = 187;
            lp_accum__.add(lkj_corr_cholesky_log<propto__>(chol_r_p, 2));
...
typedef model_RRc_con_comp_g0_namespace::model_RRc_con_comp_g0 stan_model;
#ifndef USING_R
