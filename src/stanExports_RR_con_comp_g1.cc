...
#include "stanExports_RR_con_comp_g1.h"

RCPP_MODULE(stan_fit4RR_con_comp_g1_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_RR_con_comp_g1")
