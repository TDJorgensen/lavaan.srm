...
class model_RR_con_comp_g0
  : public stan::model::model_base_crtp<model_RR_con_comp_g0> {
private:
        int Nd;
        int Np;
        int Kd2;
...
typedef model_RR_con_comp_g0_namespace::model_RR_con_comp_g0 stan_model;
#ifndef USING_R
