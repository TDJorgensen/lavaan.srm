...
#include "stanExports_RRc_con_comp_g0.h"

RCPP_MODULE(stan_fit4RRc_con_comp_g0_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_RRc_con_comp_g0")
